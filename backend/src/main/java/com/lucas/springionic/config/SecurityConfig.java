...
import com.lucas.springionic.security.JWTAuthenticationFilter;
import com.lucas.springionic.security.JWTUtil;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.DELETE, PUBLIC_MATCHER_GET).permitAll()
